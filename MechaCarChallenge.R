...
library(tidyverse)
mecha_mpg <- read.csv(file='Desktop/Mecha_RStudio/MechaCar_mpg.csv',check.names=F,stringsAsFactors = F)
...
sus_coil <- read.csv(file='Desktop/Mecha_RStudio/Suspension_Coil.csv',check.names=F,stringsAsFactors = F)
